...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //        Dark Mode Impl. temp test delete this
...
//        Dark Mode Impl. temp test delete this
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //Switch switchDarkMode = (Switch) menu.findItem(R.id.dark_mode_switch).getActionView();
    ...
    private void darkModeToggle(){
        SwitchCompat switchDarkMode = findViewById(R.id.dark_mode_switch);
